...
const getPostsController = async(req, res, next) => {
    ...
    try{
        ...
        const allPosts = await Post.find({user:{$nin:blockedUserIds}}).populate("user", "username fullName profilePic")
...
module.exports={createPostController, createPostWithImagesController,
    updatePostController, getPostsController, getUserPostController,
    deletePostController, likePostController, dislikePostController
}